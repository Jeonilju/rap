...
public class IAPAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		view = inflater.inflate(R.layout.adapter_iap_row, parent, false);                        
		viewHolder = new ViewHolder();
		viewHolder.itemImage = (ImageView) view.findViewById(R.id.iap_image);
		viewHolder.name = (TextView) view.findViewById(R.id.iap_name);
		viewHolder.buyBtn = (Button) view.findViewById(R.id.iap_buy);
